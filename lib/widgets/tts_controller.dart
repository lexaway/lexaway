...
/// Owns a generation counter so a slow in-flight `speak()` can be cancelled by
/// a subsequent question advance — otherwise synthesis for the old phrase can
/// arrive after the user has moved on and play over the new one.
class TtsController {
  final WidgetRef ref;
  ...
  /// Call when advancing questions to discard any in-flight [speak].
