...
class AttributionsScreen extends StatelessWidget {
  ...
  static const _attributions = [
    ...
    _Attribution('Interface Sounds (CC0)', 'Kenney', 'https://kenney.nl/assets/interface-sounds'),
    _Attribution('Music Jingles (CC0)', 'Kenney', 'https://kenney.nl/assets/music-jingles'),
    _Attribution('Ninja Adventure Asset Pack (CC0)', 'Pixel-boy & AAA', 'https://pixel-boy.itch.io/ninja-adventure-asset-pack'),
    _Attribution('Egg Crack SFX (CC0)', 'Reitanna (freesound)', 'https://freesound.org/people/Reitanna/sounds/244736/'),
    ...
    _Attribution('Tiny RPG — Dragon Regalia GUI (CC0)', "Gabriel 'tiopalada' Lima", 'https://tiopalada.itch.io/tiny-rpg---dragon-regalia-gui'),
